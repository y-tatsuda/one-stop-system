      ...
      for (let i = 0; i < items.length; i++) {
        ...
        const { data: inventoryData, error: inventoryError } = await supabase
          ...
          .insert({
            ...
            is_service_state: item.isServiceState || false,
            nw_status: item.nwStatus || null,
            camera_stain_level: item.cameraStain || null,
            camera_broken: item.cameraBroken || false,
            repair_history: item.repairHistory || false,
            repair_types: item.selectedRepairs?.length > 0 ? item.selectedRepairs.join(',') : null,
            ...
            status: item.needsRepair ? '修理中' : '販売可',
